...
class MethodResult(DatabaseModel):
    ...
    @field_validator("average_content_length")
    def validate_average_content_length(cls, average_content_length: float) -> float:
        return round(average_content_length, 2)


class CreateMethodResult(MethodResult):
